...
# 
# __Answer:__ Model 0 is performing the worst, the training loss and validation loss is very high. Model 1, 3 and 4 are performing better than Model 0. Model 2 (CNN + RNN + TimeDistributed Dense) is performing the best compared to all the other Models. Both training loss and validation loss are lower than all the other Models this is because CNN is being used to present visual representaion of the audio signals. So, it provides better input for the RNN.
...
model_end = final_model(input_dim=161,
                        ...
                        conv_border_mode='valid',
                        units=200,
                        output_dim=29, drop_out_rate=0.5
                       )
...
# 
# __Answer:__ Since, Model 2 is performing the best, I have used this Model (CNN + RNN + TimeDistributed Dense).
#             Final model architecture:
#             1) 1 Convolutional layer
#             2) 3 GRU layers
#             3) 1 Bidirectional layer
#             4) 1 Time Distributed layer
#             Both training loss and validation loss is quite low using this Model.
